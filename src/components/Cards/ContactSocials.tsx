...
const ContactSocialItem = ({
  ...
  return (
    ...
    className="bg-primary text-slate-300 hover:bg-slate-400 hover:text-primary h-10 w-10 rounded-full flex items-center justify-center shrink-0"
    >
      <Link
        href={link}
        target="_blank"
      ...
      >
        <Icon className="text-slate-300 hover:text-primary w-6 h-6" />
      </Link>
    </motion.li>
  );
};
